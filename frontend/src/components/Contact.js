                ...
                <div className="contact-box">
                    <motion.div className="left-box" initial={{opacity: 0, y: '-50px'}} whileInView={verticalLeft}>
                        ...
                        <div className="contact-hello">
                            <p>Say Hello</p>
                            <Link className='hello-links' to="//wa.me/+919553005205" target='_blank'>wa.me/ameer</Link>
                            <a className='hello-links' href="mailto:ameerkhan20241a0497@gmail.com" target='_blank' rel="noreferrer">ameerkhan20241a0497@gmail.com</a>
                        </div>
                    </motion.div>
                    <motion.div className="right-box" initial={{opacity: 0, y: '50px'}} whileInView={verticalLeft}>
                        ...
                        <form
                            ...
                            method="POST"
                            data-netlify="true"
                             action="https://portfolio-backend-bice-zeta.vercel.app"
                        >
